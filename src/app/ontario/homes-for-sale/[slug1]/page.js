...
export async function generateMetadata({ params }, parent) {
  return {
    ...parent,
    alternates: {
      canonical: `https://homebaba.ca/resale/ontario/homes-for-sale/${params.slug1}`,
    },
    openGraph: {
      images: "/favicon.ico",
    },
    title: `100+ ${params.slug1} Homes for sale | Detached, Semis & Towns | Homebaba`,
    description: `Find houses for sale in ${params.slug1}. Visit Homebaba.ca to see all the ${params.slug1} real estate listings on the MLS® Systems today! Prices starting at $1 💰`,
  };
}
