  ...
  const resaleRoutes = [
    ...
    // Property type routes
    {
      ...
      subpages: [
        ...
        "resale/ontario/town-homes-for-sale",
        "resale/ontario/condo-for-sale",
        "resale/ontario/detached-homes-for-lease",
        "resale/ontario/semi-detached-homes-for-lease",
        "resale/ontario/town-homes-for-lease",
        "resale/ontario/condo-for-lease",
    ...
    ...preconCityList.map((city) => ({
      ...
      subpages: [
        ...
        `resale/ontario/${cleanSlug(city.city_name)}/town-homes-for-sale`,
        `resale/ontario/${cleanSlug(city.city_name)}/condo-for-sale`,
        `resale/ontario/${cleanSlug(city.city_name)}/detached-homes-for-lease`,
        `resale/ontario/${cleanSlug(
          city.city_name
        )}/semi-detached-homes-for-lease`,
        `resale/ontario/${cleanSlug(city.city_name)}/town-homes-for-lease`,
        `resale/ontario/${cleanSlug(city.city_name)}/condo-for-lease`,
